                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-info">
                                <!-- form start -->
                                <form action="post_insert.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    <div class="card-body">
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <a href="post_show.php" class="btn btn-default float-right">ยกเลิก</a>
                                    </div>
                                    <!-- /.card-footer -->
                                </form>
                            </div>
