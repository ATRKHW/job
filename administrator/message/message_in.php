<?php
    ...
    $user_reciever_id = $_SESSION['user_id'];
    $sql = "SELECT messages.message_id AS message_id, users.user_full_name AS sender, messages.message_description AS message_description FROM users INNER JOIN messages ON users.user_id = messages.user_sender_id WHERE messages.user_reciever_id = '".$user_reciever_id."'";
